    ...
    <form action="{{url('coach/updatestudent/'.$student->id)}}" method ="post" enctype="multipart/form-data">
      ...
      @method('put')
          ...
          <div class="form-group mt-3">
            ...
            <input type="text" name ="name" value="{{$student->student->user_name ?? ''}}" class="form-control" id="name" aria-describedby="emailHelp" disabled >
        ...
        <div class="form-group">
          <label for="school_city">Password</label>
          <input type="password" name ="password"   value=""  class="form-control" id="location" aria-describedby="emailHelp" >
          {{-- <span class ="text-danger">@error('school_city'){{$message}} @enderror</span> --}}
