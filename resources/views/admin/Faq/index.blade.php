       ...
       <div class="col-md-12">
        ...
        <div class="col-md-12 mt-2">
            <div class="card">
                ...
                <a href="{{ url('admin/addfaq')}}"  class="btn btn-success btn-sm mt-3"> <i class="fa fa-plus mr-2"></i> Add FAQ</a>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td>
                                        <a href={{url('admin/editfaq/'.$faqs->id)}} class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                    <td>
                                        
                                        <a href={{url('admin/delete/'.$faqs->id)}} class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')" ><i class="fa fa-trash" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
