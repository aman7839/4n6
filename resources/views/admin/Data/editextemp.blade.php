        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="topic_id" id="topic_id" class="form-control required">
                ...
                <option value="{{$item->id}}" {{$item->id == $topic->topic_id ? 'selected' :''}}>
                  {{$item->name}}
                </option>
              ...
              <p class="text-danger">@error('topic_id'){{$message}} @enderror</p>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="question" id="question" class="form-control" cols="50" rows="3"> {{$topic->question}} </textarea>
              <p class="text-danger">@error('question'){{$message}} @enderror</p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
          ...
          <div class="col-md-12"> <a href="{{url('admin/extempview')}}" class="btn btn-danger">Cancel</a>
