        ...
        <div class="col-md-12 mt-2">
            <div class="card">
                <div class="card-header ida_header">
                    {{-- <div class="d-flex">
                        <h4><a href="{{ url('admin/tutorial')}}" class="btn btn-secondary btn-sm "> <i class="fa fa-chevron-left"></i> Back</a></h4>
                        <h4 class="title_cmn">IDA Manager</h4>
                    </div> --}}
                    <h4><a href="{{ url('admin/addtutorial')}}" class="btn btn-primary btn-sm admin_cm_btn"> <i class="fa fa-plus mr-2"></i> Add Tutorial Video</a></h4>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $videos->id }}</td>
                                    <td>{{ $videos->name}}</td>
                                    <td><a href="{{ '../public/images/'.$videos->video}}">{{ $videos->video }}</a></td>
                                    ...
                                    <td>
                                        <a href={{url('admin/edittutorial/'.$videos->id)}} class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                    <td>

                                        <a href={{url('admin/deletetutorial/'.$videos->id)}} class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
