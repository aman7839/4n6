        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header ida_header">
                    <div class="d-flex">
                        <a href="{{ route('admin.activeMembership') }}" class="btn btn-secondary btn-sm"><i class="fa fa-chevron-left"></i> Go Back</a>
                    ...
                    <form action="{{route('admin.updateMembership')}}" id="transaction_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-2">
                                <a href="{{ route('admin.activeMembership') }}" class="btn btn-danger">Cancel</a>
                                <button class="btn btn-success admin_cm_btn" type="submit">Update</button>
                            </div>
                        </div>
                    </form>
