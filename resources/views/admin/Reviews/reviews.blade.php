...
{{-- end modal --}}
     ...
     <div class="modal fade" id="addscreenshot" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Screenshot<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button></h5>
                    <!-- <input type="text" id="selectedid"> -->
          ...
          <input type="text" name="name" class="form-control"  value= ""/> --}}
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="" name="screenshot" class="form-control" placeholder="Folder Name">
                                </div>
                            </div>
