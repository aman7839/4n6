    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-3 border-right pl-0">
                <div class="tree">
                    <ul id="myUL">
                        ...
                        <li>
                            <span class="caret {{ count($valult->nested_categories) == 0 ? 'empty_folder' : '' }}"><i class="fa fa-folder-open"></i> </span>
                            <span class="tree_folder tree_folder_name tree_folder_editname" data-name="{{ $valult->name }}" data-id="{{ $valult->id }}">{{ $valult->name }}
                            </span>
            ...
            <div class="col-md-9">
                ...
                @if (empty($membership) )
               <div class="col-12">
               <div class="transcetion_card text-center">
                    <img src="{{asset('/public/4n61/images/restricted.svg')}}" alt="">
                </div>
...
<div class="modal fade" id="foldermodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Create Folder <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <form class="vault_form" method="post" id="create_folder_form" action="{{ url('admin/savefolder') }}">
                    ...
                    <div class="form-outline">
                        <label class="form-label" for="form2Example1">Parent Folder: </label> <span class="parent_name_class" id="parent-name"></span>
                    </div>
...
<div class="modal fade" id="editfolder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Folder <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button></h5>
                <!-- <input type="text" id="selectedid"> -->
          ...
          <input type="text" name="name" class="form-control"  value= ""/> --}}
                        ...
                        <div class="">
                            <div class="form-group">
                                <label for="name"> Folder Name <span class="text-danger">*</span> </label>
                                <input type="text" id="edit_name" name="name" class="form-control" placeholder="Folder Name">
                            </div>
                        </div>
...
<div class="modal fade" id="fileupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fileuploadmodel">Upload File<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button></h5>
                <!-- <input type="text" id="selectedid"> -->
...
<script>
    jQuery(document).ready(function() {
        ...
        jQuery(".tree_folder").on('click', function() {
            ...
            ///
            jQuery.ajax({
                url: "{{ 'coach_folder_data' }}" + '/' + parent_id,
                type: 'get',
                success: function(data) {
